...
> **Superseded in part (ADR-0014):** Focus is no longer a shared catalog. It's free text set
> per (Line, Event) directly. Skill and Development goal keep the shared-catalog model described
> above.
